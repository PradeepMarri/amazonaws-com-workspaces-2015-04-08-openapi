...
func DeleteconnectionaliasHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeleteConnectionAliasRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=WorkspacesService.DeleteConnectionAlias", cfg.BaseURL)
		...
		var result models.DeleteConnectionAliasResult
...
func CreateDeleteconnectionaliasTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeleteconnectionaliasHandler(cfg),
	}
}
