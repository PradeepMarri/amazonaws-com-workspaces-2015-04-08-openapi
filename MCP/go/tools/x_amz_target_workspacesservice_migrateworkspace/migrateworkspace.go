...
func MigrateworkspaceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.MigrateWorkspaceRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=WorkspacesService.MigrateWorkspace", cfg.BaseURL)
		...
		var result models.MigrateWorkspaceResult
