...
func TerminateworkspacesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.TerminateWorkspacesRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=WorkspacesService.TerminateWorkspaces", cfg.BaseURL)
		...
		var result models.TerminateWorkspacesResult
