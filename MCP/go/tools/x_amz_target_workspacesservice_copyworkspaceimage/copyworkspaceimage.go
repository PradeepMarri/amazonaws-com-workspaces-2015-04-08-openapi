...
func CopyworkspaceimageHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CopyWorkspaceImageRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=WorkspacesService.CopyWorkspaceImage", cfg.BaseURL)
		...
		var result models.CopyWorkspaceImageResult
...
func CreateCopyworkspaceimageTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    CopyworkspaceimageHandler(cfg),
	}
}
