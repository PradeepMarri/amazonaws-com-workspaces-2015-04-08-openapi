...
func AssociateconnectionaliasHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.AssociateConnectionAliasRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=WorkspacesService.AssociateConnectionAlias", cfg.BaseURL)
		...
		var result models.AssociateConnectionAliasResult
...
func CreateAssociateconnectionaliasTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    AssociateconnectionaliasHandler(cfg),
	}
}
