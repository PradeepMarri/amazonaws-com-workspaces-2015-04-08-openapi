...
func ListavailablemanagementcidrrangesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListAvailableManagementCidrRangesRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=WorkspacesService.ListAvailableManagementCidrRanges", cfg.BaseURL)
		...
		var result models.ListAvailableManagementCidrRangesResult
...
func CreateListavailablemanagementcidrrangesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=WorkspacesService_ListAvailableManagementCidrRanges",
		...
		mcp.WithString("ManagementCidrRangeConstraint", mcp.Required(), mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListavailablemanagementcidrrangesHandler(cfg),
	}
}
